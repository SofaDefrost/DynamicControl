...
function [ snapshotMatrix ] = readSnapshotVelocity( numNodes,modelName,sofaDataFolder )
%READSNAPSHOTVELOCITY Read a text file saved in sofa containing velocity
%of the robot at each time step. Returns velocity snapshot matrix.
%
% See also SOFA.COMPUTEMOREPOD, SOFA.COMPUTEREDUCTION,
% SOFA.READSNAPSHOTPOSITION
...
fid=fopen(strcat(sofaDataFolder,'/',modelName,'/SnapshotVelocity',modelName,'.txt'),'r');
